...
object WalletPreferencesManager {
    ...
    fun putCategoryItemViewType(categoryItemViewTypeEnum: CategoryItemViewTypeEnum) =
        Prefs.put(PREF_CATEGORY_ITEM_VIEW_TYPE, categoryItemViewTypeEnum.type)

    fun getCategoryItemViewType(): CategoryItemViewTypeEnum = CategoryItemViewTypeEnum.from(
        Prefs.getInt(
            PREF_CATEGORY_ITEM_VIEW_TYPE,
            CategoryItemViewTypeEnum.GRID.type
        )
    )
